...
class ParentTimeProgressContainer extends StatelessWidget {
  ...
  Widget _buildKidBar(BuildContext context, int start, int end, int now, int globalStart, double pxPerMin) {
    ...
    double totalKidWidth = (end - start) * pxPerMin;
    double rightOffset = (containerWidth - (leftOffset + totalKidWidth)) + 2;
