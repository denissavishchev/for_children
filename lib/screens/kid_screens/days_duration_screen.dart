...
class _DaysDurationScreenState extends State<DaysDurationScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<KidProvider>(context, listen: false).getDayDurationData(context);
    });
  }
      ...
      body: SafeArea(
        child: Consumer<KidProvider>(
          builder: (context, data, _) {
            final reversedData = data.durationsList.reversed.toList();
            List displayList = [];
            String monthLabel = '';
            String weekRange = '';
            ...
            final int totalDays = data.durationsList.length;
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      spacing: 12,
                      children: [
                        _filterButton(weekButtonLabel, false),
                        _filterButton('month'.tr(), true),
                      ],
                    ),
                  ),
                  if (_isMonthView)
                    Text(monthLabel, style: kBigTextStyle.copyWith(color: kGrey, fontSize: 32.sp))
                  else
                    Row(
                  ...
                  Container(
                    width: size.width,
                    constraints: const BoxConstraints(maxHeight: 450, minHeight: 50),
                    ...
                    child: displayList.isEmpty
                        ? const Center(child: SpinKitSpinningLines(
                      color: kBlue,
                      size: 40,
                    ))
                        : BarChart(
  ...
  Widget _filterButton(String label, bool isMonth) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(
                color: active ? kDarkWhite : kGrey.withValues(alpha: 0.2),
                width: 1
            ),
