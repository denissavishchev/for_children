...
class KidOnboardingScreenSix extends StatelessWidget {
  const KidOnboardingScreenSix({super.key,
  });
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  Expanded(child: Text('startWithFirstSimpleTaskKid'.tr(), style: kTextStyle,)),
                                ],
                              ),
                              Row(
                                spacing: 12,
                                children: [
                                  SvgPicture.asset('assets/icons/check.svg', width: 16,),
                                  Expanded(child: Text('monitorProgressAndPraiseEffortsKid'.tr(), style: kTextStyle,)),
                                ],
                              ),
                              Row(
                                spacing: 12,
                                children: [
                                  SvgPicture.asset('assets/icons/check.svg', width: 16,),
                                  Expanded(child: Text('shareThoughtsAndIdeasWithYourChildKid'.tr(), style: kTextStyle,)),
                                ],
                              ),
                            ],
                          ),
